"""
Automatic DTI-ALPS ROI Detection

This module provides the core algorithm for automatically identifying optimal
ROI locations for DTI-ALPS (Diffusion Tensor Imaging Along the Perivascular
Space) analysis by detecting adjacent projection and association fiber regions.
